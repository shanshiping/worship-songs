...
- 每首歌可上传**多页**歌谱（PNG/JPG/PDF 可混排）
- **主领选歌**（`/sheets`）：填写主题/经文获取历史参考 → 搜索或首字母选歌 → 右侧合并预览 PDF → 打印或下载
