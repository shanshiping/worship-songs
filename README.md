...
| **主领选歌** | 主题/经文历史参考、首字母与搜索选歌、合并多页歌谱 PDF、预览/打印/下载/分享、主领选歌统计 | `/sheets` `/sheets/leaders` |
...
- 👤 **主领统计** - 按主领汇总常用歌曲与聚会次数；可按年份筛选（`/sheets/leaders`，主领选歌页入口）
...
**路由：** `/sheets/leaders`（主领选歌页「主领选歌统计」入口；旧链接 `/meetings/leaders` 会自动跳转）
